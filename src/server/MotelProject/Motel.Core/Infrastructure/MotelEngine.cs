...
using Motel.Core.Infrastructure.Mapper;
using System;
...
{
    public class MotelEngine:IEngine
    {
        #region Fields
        ...
        public void ConfigureRequestPipeline(IApplicationBuilder application)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<IMotelStartup>();
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new MotelException("Unknown dependency");
                        return service;
                    });
            ...
            throw new MotelException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
