...
namespace Motel.Api.Framework.Jwt
{
    public class TokenFactoryService : ITokenFactoryService
    {
        ...
        #region Fields
        protected readonly  IRolesUserServices _rolesUserServices;
        protected readonly IOptionsSnapshot<BearerTokensOptions> _configuration;
        ...
        public string GetRefreshTokenSerial(string refreshTokenValue)
        {
            ...
            {
                _logger.Error($"Failed to validate refreshTokenValue",ex);
            }
