...
namespace Nop.Services.Configuration
{
    ...
    public partial class SettingService : ISettingService
    {
        ...
        protected virtual IDictionary<string, IList<Setting>> GetAllSettingsDictionary()
        {
            ...
            return _staticCacheManager.Get(MotelConfigurationDefaults.SettingsAllAsDictionaryCacheKey, () =>
            {
        ...
        public virtual IList<Setting> GetAllSettings()
        {
            ...
            //we can not use ICacheKeyService because it'll cause circular references.
            //that's why we use the default cache time
            var settings = query.ToCachedList(MotelConfigurationDefaults.SettingsAllCacheKey);
        ...
        {
            _staticCacheManager.RemoveByPrefix(MotelConfigurationDefaults.SettingsPrefixCacheKey);
        }
