...
namespace Motel.Services.Media
{
     public partial class PictureService : IPictureService
    {
        ...
        private readonly IRepository<PostPictureMaping> _postPictureRepository;
        ...
        public PictureService(IMotelDataProvider dataProvider,
        ...
        protected virtual void DeletePictureThumbs(Picture picture)
        {
            ...
            var currentFiles = _fileProvider.GetFiles(_fileProvider.GetAbsolutePath(MotelMediaDefaults.ImageThumbsPath), filter, false);
        ...
        {
            var thumbsDirectoryPath = _fileProvider.GetAbsolutePath(MotelMediaDefaults.ImageThumbsPath);

            if (_mediaSettings.MultipleThumbDirectories)
            {
                //get the first two letters of the file name
                var fileNameWithoutExtension = _fileProvider.GetFileNameWithoutExtension(thumbFileName);
                if (fileNameWithoutExtension != null && fileNameWithoutExtension.Length > MotelMediaDefaults.MultipleThumbDirectoriesLength)
                {
                    var subDirectoryName = fileNameWithoutExtension.Substring(0, MotelMediaDefaults.MultipleThumbDirectoriesLength);
                    thumbsDirectoryPath = _fileProvider.GetAbsolutePath(MotelMediaDefaults.ImageThumbsPath, subDirectoryName);
            ...
            string storeLocation = null)
        {
            ...
            {
                PictureType.Avatar => _settingService.GetSettingByKey("Media.Customer.DefaultAvatarImageName", MotelMediaDefaults.DefaultAvatarFileName),
                _ => _settingService.GetSettingByKey("Media.DefaultImageName", MotelMediaDefaults.DefaultImageFileName),
            };
