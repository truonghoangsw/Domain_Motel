...
namespace Motel.Services.Common
{
    public partial interface  IGenericAttributeService
    {
        ...
        TPropType GetAttribute<TPropType>(BaseEntity entity, string key, TPropType defaultValue = default);
        ...
        /// <param name="defaultValue">Default value</param>
        /// <returns>Attribute</returns>
        TPropType GetAttribute<TEntity, TPropType>(int entityId, string key, TPropType defaultValue = default)
